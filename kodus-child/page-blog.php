...
$page_title    = ($current_lang === 'en') ? 'Insights' : 'Insights';
...
<main class="blog-page">
  ...
  <header class="blog-page__header">
    <h1 class="blog-page__title"><?php echo esc_html($page_title); ?></h1>
    <p class="blog-page__subtitle"><?php echo esc_html($page_subtitle); ?></p>

    <!-- Language selector -->
    <nav class="blog-page__langs" aria-label="Language">
      <?php foreach ($lang_links as $l) : ?>
        <a href="<?php echo esc_url($l['url']); ?>"
           class="blog-lang-btn<?php echo $l['active'] ? ' blog-lang-btn--active' : ''; ?>"
  ...
  <?php if ($has_more) : ?>
    <div class="blog-page__load-more">
      <button class="btn btn--outline" id="blog-load-more"
