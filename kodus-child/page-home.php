                ...
                <div class="basics__content-body" id="basicsDetail">
                  ...
                  <div class="basics__panel" id="basics-panel-0">
                    ...
                    <div class="basics__video">
                      <video data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/context.webm" autoplay loop muted playsinline preload="none" class="js-lazy-video" style="width: 100%; height: auto; display: block;"></video>
                    </div>
                  ...
                  <div class="basics__panel" id="basics-panel-1" style="display: none;">
                    ...
                    <div class="basics__video">
                      <video data-src="https://kodus.io/wp-content/uploads/2026/02/1111.mp4" autoplay loop muted playsinline preload="none" class="js-lazy-video" style="width: 100%; height: auto; display: block;"></video>
                    </div>
                  ...
                  <div class="basics__panel" id="basics-panel-3" style="display: none;">
                    ...
                    <div class="basics__video">
                      <video data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/plugins.webm" autoplay loop muted playsinline preload="none" class="js-lazy-video" style="width: 100%; height: auto; display: block;"></video>
                    </div>
                  ...
                  <div class="basics__panel" id="basics-panel-4" style="display: none;">
                    ...
                    <div class="basics__video">
                      <video data-src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/issues.webm" autoplay loop muted playsinline preload="none" class="js-lazy-video" style="width: 100%; height: auto; display: block;"></video>
                    </div>
